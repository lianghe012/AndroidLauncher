...
public class WallpaperCropActivity extends Activity {
    ...
    protected void init() {
        ...
        View view = getLayoutInflater().inflate(R.layout.actionbar_set_wallpaper, null);
...
//        mSetWallpaperButton = findViewById(R.id.set_wallpaper_button);
        mSetWallpaperButton = view.findViewById(R.id.set_wallpaper_button);
