...
public class LauncherProvider extends ContentProvider {
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        // after that point
        public long generateNewScreenId() {
        	Log.i("super_hw", "LauncherProvider_generateNewScreenId()");
            if (mMaxScreenId < 0) {
        ...
        private long initializeMaxScreenId(SQLiteDatabase db) {
        	Log.i("super_hw", "LauncherProvider_initializeMaxScreenId()");
        ...
        private int loadFavorites(SQLiteDatabase db, AutoInstallsLayout loader) {
            ...
            Log.w("super_hw", "LauncherProvider_loadFavorites() mMaxItemId: " + mMaxItemId + " mMaxScreenId: " + mMaxScreenId);
            return count;
        }
        ...
        public void initMaxScreenInfo(){
        	mMaxItemId = initializeMaxItemId(getWritableDatabase());
          mMaxScreenId = initializeMaxScreenId(getWritableDatabase());
          Log.i("super_hw", "LauncherProvider_initMaxScreenInfo() mMaxItemId: " + mMaxItemId + " mMaxScreenId: " + mMaxScreenId);
        }
