...
public class AppInfo extends ItemInfo {
    ...
    int flags = 0;
    public boolean isFirstScreenAdd = false;
    ...
    public AppInfo(ShortcutInfo sInfo) {
        super(sInfo);
		if (sInfo.appInfo != null) {
			intent = new Intent(sInfo.appInfo.intent);
			this.componentName = sInfo.appInfo.componentName;
			this.container = sInfo.appInfo.container;
			this.flags = sInfo.appInfo.flags;
		}
    }
