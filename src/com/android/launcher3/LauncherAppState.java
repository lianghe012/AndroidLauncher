...
public class LauncherAppState implements DeviceProfile.DeviceProfileCallbacks {
    ...
    public final boolean isPSLauncher = true;
    ...
    static DynamicGrid createDynamicGrid(Context context, DynamicGrid dynamicGrid) {
        ...
        if (dynamicGrid == null) {
            ...
            Log.e("createDynamicGrid","smallestSize.x>>>"+smallestSize.x);
            Log.e("createDynamicGrid","smallestSize.y>>>"+smallestSize.y);
            Log.e("createDynamicGrid","largestSize.x>>>"+largestSize.x);
            Log.e("createDynamicGrid","largestSize.y>>>"+largestSize.y);
