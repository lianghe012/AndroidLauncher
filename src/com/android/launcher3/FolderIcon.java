...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        lp.topMargin = (int) Math.max(0, ((grid.cellWidthPxNew - grid.cellHeightPx) / 2f));
    ...
    private void computePreviewDrawingParams(int drawableSize, int totalSize) {
            ...
            DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
//            if(grid.isLandscape){
//            	  mIntrinsicIconSize = grid.iconSizePx;
//            }else{
//            	  mIntrinsicIconSize = 66;
//            }
            mIntrinsicIconSize = grid.iconSizePx;
            mTotalWidth = totalSize;
            final int previewSize = mPreviewBackground.getLayoutParams().height;
            final int previewPadding = FolderRingAnimator.sPreviewPadding;
            Log.e("computePreviewDrawingParams","mIntrinsicIconSize>>>"+mIntrinsicIconSize);
            Log.e("computePreviewDrawingParams","mTotalWidth>>>"+mTotalWidth);
            Log.e("computePreviewDrawingParams","previewSize>>>"+previewSize);
            Log.e("computePreviewDrawingParams","previewPadding>>>"+previewPadding);
...
//            if(grid.isLandscape){
//                mPreviewOffsetY = previewPadding + 2;
//                mPreviewOffsetX = (mTotalWidth - mAvailableSpaceInPreview) / 2;
//            }else{
//                mPreviewOffsetY = previewPadding + 1;
//                mPreviewOffsetX = (mTotalWidth - mAvailableSpaceInPreview) / 2-1;
//            }
            mPreviewOffsetY = previewPadding+2;
            mPreviewOffsetX = (mTotalWidth - mAvailableSpaceInPreview) / 2+2;
    }
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
    	...
    	float transY = getPaddingTop() + index / 3 * 22;
    	float transX = index % 3 * 23;
      if (params == null) {
    	  params = new PreviewItemDrawingParams(transX, transY, 1,1);
      } else {
    ...
    private void drawPreviewItem(Canvas canvas, PreviewItemDrawingParams params,int i) {
        canvas.save();
        LauncherAppState app = LauncherAppState.getInstance();
        DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
        float x = 0;
...
//        if(!grid.isLandscape){
//           	if(i < 3){
//           		y = params.transY + mPreviewOffsetY;
//        	}else if(i > 2 && i< 6){
//        		y = params.transY + mPreviewOffsetY-2;
//        	}else{
//        		y = params.transY + mPreviewOffsetY-4;
//        	}
//           	if(i%3 == 0){
//           		x = params.transX + mPreviewOffsetX;
//           	}else if(i%3 == 1){
//           		x = params.transX + mPreviewOffsetX-1;
//           	}else{
//           		x = params.transX + mPreviewOffsetX-2;
//           	}
//    		canvas.translate(x,y);
//        }else{
//        	canvas.translate(params.transX + mPreviewOffsetX, params.transY + mPreviewOffsetY);
//        }
        Log.e("oiioioioi","params.transX + mPreviewOffsetX>>"+params.transX + mPreviewOffsetX);
        Log.e("oiioioioi","transX>>"+params.transX);
        Log.e("oiioioioi","transY>>"+params.transY);
        Log.e("oiioioioi","mPreviewOffsetX>>"+mPreviewOffsetX);
        if(grid.densityDPI > 240){
        	   if(i < 3){
               	canvas.translate(params.transX*2.2f + mPreviewOffsetX, params.transY + mPreviewOffsetY); 	
               }else if(i > 2 && i< 6){
               	canvas.translate(params.transX*2.2f + mPreviewOffsetX, params.transY*1.46f + mPreviewOffsetY);
               }else{
               	canvas.translate(params.transX*2.2f + mPreviewOffsetX, params.transY*1.67f + mPreviewOffsetY);
               }
        }else{
        	if(grid.isLandscape){
        		if(i< 3){
            	    canvas.translate(params.transX * 0.85f + mPreviewOffsetX, params.transY + mPreviewOffsetY);         	
            	}else if(i > 2 && i< 6){
            	    canvas.translate(params.transX * 0.85f + mPreviewOffsetX, params.transY * 0.9f + mPreviewOffsetY);  	
            	}else{
            	    canvas.translate(params.transX * 0.85f + mPreviewOffsetX, params.transY* 0.9f + mPreviewOffsetY);  
            	}
        	}else{
        		if(i< 3){
            	    ...
            	    canvas.translate(params.transX * 0.85f + mPreviewOffsetX, params.transY * 0.966f + mPreviewOffsetY);  	
            	}else{
            	    canvas.translate(params.transX * 0.85f + mPreviewOffsetX, params.transY* 0.949f + mPreviewOffsetY);  
            	}
        	}
        }
        ...
        if (d != null) {
            ...
            if(grid.densityDPI > 240){
         	    d.setBounds(0, 0, mIntrinsicIconSize/4-3, mIntrinsicIconSize/4-3);	
            }else{
         	    d.setBounds(0, 0, mIntrinsicIconSize/4-1, mIntrinsicIconSize/4-1);
            }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Log.e("computePreviewDrawingParams","dispatchDraw");
        if (mFolder == null) return;
        if (mFolder.getItemCount() == 0 && !mAnimating) return;
        Log.e("computePreviewDrawingParams","dispatchDraw1");
        ...
        if (!mAnimating) {
            for (int i = nItemsInPreview - 1; i >= 0; i--) {
                ...
                if (!mHiddenItems.contains(v.getTag())) {
                    ...
                    mParams.drawable = d;
                    drawPreviewItem(canvas, mParams,i);
                }
            }
        } else {
            drawPreviewItem(canvas, mAnimParams,mFolder.getItemCount());
        }
    }
