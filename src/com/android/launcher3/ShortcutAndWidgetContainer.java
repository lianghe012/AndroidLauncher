...
public class ShortcutAndWidgetContainer extends ViewGroup {
    ...
    private boolean mIsFoldedLayout;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int count = getChildCount();
       	Log.e("hahaF","mIsFoldedLayout>>"+mIsFoldedLayout);
        if(mIsHotseatLayout){
        	if(DEBUG){
               	Log.e(TAG,"count>>"+count);
        	}
        }else if(mIsFoldedLayout){
        	if(DEBUG){
               	Log.e("hahaF","count>>"+count);
        	}
        }
    ...
    public void measureChild(View child) {
        ...
        CellLayout.LayoutParams lp = (CellLayout.LayoutParams) child.getLayoutParams();
        if (!lp.isFullscreen) {
        	lp.setMisHost(mIsHotseatLayout);
            ...
            if (child instanceof LauncherAppWidgetHostView) {
                ...
                Log.e("test","lp.height>>>"+lp.height);
...
//                child.setBackgroundColor(getResources().getColor(R.color.Red_text));
            }
        }
    }
	...
	public boolean ismIsFoldedLayout() {
		return mIsFoldedLayout;
	}

	public void setmIsFoldedLayout(boolean mIsFoldedLayout) {
		this.mIsFoldedLayout = mIsFoldedLayout;
	}
}
