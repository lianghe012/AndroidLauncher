...
//        setBackgroundColor(getResources().getColor(R.color.yellow));
    ...
    public void onDragStart(final DragSource source, Object info, int dragAction) {
    	Log.i("super_hw", "Workspace_onDragStart");
    ...
    public void onDragEnd() {
    	Log.i("super_hw", "Workspace_onDragEnd");
    ...
    public long insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        Log.i("super_hw", "Workspace_insertNewWorkspaceScreen()");
    ...
    public void createCustomContentContainer() {
    	Log.i("super_hw", "Workspace_createCustomContentContainer()");
    ...
    public void addExtraEmptyScreenOnDrag() {
        ...
        Log.i("super_hw", "Workspace_addExtraEmptyScreenOnDrag()");
    ...
    public boolean addExtraEmptyScreen() {
        ...
        Log.w("super_hw", "Workspace_addExtraEmptyScreen()");
    ...
    public boolean addEmptyScreenByScreenId(long newScreenId){
        Log.w("super_hw", "Workspace_addEmptyScreenByScreenId()");
        boolean isContainsEmptyScreen = false;
        try {
        	if (!mWorkspaceScreens.containsKey(EXTRA_EMPTY_SCREEN_ID)) {
        		insertNewWorkspaceScreen(EXTRA_EMPTY_SCREEN_ID);
        		isContainsEmptyScreen = false;
        	} else {
        		isContainsEmptyScreen = true;
        	}
        	...
        	if(LauncherAppState.getLauncherProvider().generateNewScreenId() <= newScreenId)
        		LauncherAppState.getLauncherProvider().updateMaxScreenId(newScreenId);
        	if(mLauncher != null && mLauncher.getModel() != null)
        		mLauncher.getModel().updateWorkspaceScreenOrder(mLauncher, mScreenOrder);
        	if(isContainsEmptyScreen)
        		addExtraEmptyScreen();
        	Log.i("super_hw", "Workspace_addEmptyScreenByScreenId() true");
        	return true;
		} catch (Exception e) {
			e.printStackTrace();
		}
        Log.i("super_hw", "Workspace_addEmptyScreenByScreenId() false");
    	return false;
    }
    ...
    public void removeExtraEmptyScreen(final boolean animate, boolean stripEmptyScreens) {
    	Log.i("super_hw", "Workspace_removeExtraEmptyScreen");
    ...
    public void removeExtraEmptyScreenDelayed(final boolean animate, final Runnable onComplete,
    	...
    	Log.i("super_hw", "Workspace_removeExtraEmptyScreenDelayed");
        // Log to disk
    ...
    public long commitExtraEmptyScreen() {
        ...
        Log.i("super_hw", "Workspace_commitExtraEmptyScreen(), newId:" + newId);
    ...
    void addInScreen(View child, long container, long screenId,
    	...
    	Log.i("super_hw", "Workspace addInScreen1()");
    ...
    void addInScreenFromBind(View child, long container, long screenId, int x, int y,
            int spanX, int spanY) {
    	Log.i("super_hw", "Workspace addInScreen() callby addInScreenFromBind()");
    ...
    void addInScreen(View child, long container, long screenId, int x, int y, int spanX, int spanY,
            boolean insert) {
    	Log.i("super_hw", "Workspace addInScreen2()");
    ...
    void addInScreen(View child, long container, long screenId, int x, int y, int spanX, int spanY,
    	...
    	Log.i("super_hw", "Workspace addInScreen3()");
...
//        if (container == LauncherSettings.Favorites.CONTAINER_HOTSEAT) {
//        	Log.e("addInScreen","lp.cellX>>"+lp.cellX);
//        	Log.e("addInScreen","lp.cellY>>"+lp.cellY);
//        	Log.e("addInScreen","lp.cellHSpan>>"+lp.cellHSpan);
//        	Log.e("addInScreen","lp.cellVSpan>>"+lp.cellVSpan);
//        }
...
//    	Log.v("super_hw", "WorkSpace OnInterceptTouchEvent");
    ...
    */
    ...
    protected void onEndReordering() {
        ...
        Log.i("super_hw", "Workspace_onEndReordering()");
        for (int i = 0; i < count; i++) {
            CellLayout cl = ((CellLayout) getChildAt(i));
    ...
    void startDrag(CellLayout.CellInfo cellInfo) {
        ...
        mDragInfo = cellInfo;
        /** TODO 这个地方需要注意一下,脑补一下 */
        Log.d("super_hw", "Workspace_startDrag(), child.setVisibility(INVISIBLE);拖动时隐藏桌面的view");
        child.setVisibility(INVISIBLE);
        if(mLauncher != null && !(child instanceof LauncherAppWidgetHostView))
        	mLauncher.addDragView(child);
    ...
    public void beginDragShared(View child, DragSource source) {
    	Log.i("super_hw", "workspace line 1897 beginDragShared child : " + child.toString());
        child.clearFocus();
    ...
    void addApplicationShortcut(ShortcutInfo info, CellLayout target, long container, long screenId,
    	...
    	Log.d("super_hw", "workspace addApplicationShortcut");
    ...
    public boolean acceptDrop(DragObject d) {
    	Log.i("super_hw", "Workspace acceptDrop()");
    ...
    public void onDrop(final DragObject d) {
    	Log.w("super_hw", "Workspace onDrop");
        ...
        if (d.dragSource != this) {
            ...
            Log.w("super_hw", "Workspace onDrop line 3096");
    ...
    public void onDragEnter(DragObject d) {
    	Log.i("super_hw", "Workspace onDrageEnter");
    ...
    public void onDragExit(DragObject d) {
    	Log.i("super_hw", "Workspace onDragExit");
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    private void onDropExternal(int[] touchXY, Object dragInfo,
    	...
    	Log.i("super_hw", "Workspace_onDropExternal_1");
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
    	...
    	Log.i("super_hw", "Workspace_onDropExternal_2");
        ...
        final long container = mLauncher.isHotseatLayout(cellLayout) ?
                LauncherSettings.Favorites.CONTAINER_HOTSEAT :
                    LauncherSettings.Favorites.CONTAINER_DESKTOP;
        Log.i("super_hw", "Workspace_onDropExternal_2, init screenId");
        final long screenId = getIdForScreen(cellLayout);
        Log.i("super_hw", "Workspace_onDropExternal_2, init screenId " + screenId);
        if (!mLauncher.isHotseatLayout(cellLayout)
                && screenId != getScreenIdForPageIndex(mCurrentPage)
                && mState != State.SPRING_LOADED) {
        	Log.i("super_hw", "Workspace_onDropExternal_2, init screenId mState : " + mState + " State.SPRING_LOADED : " + State.SPRING_LOADED);
            snapToScreenId(screenId, null);
        }
    ...
    public void onDropCompleted(final View target, final DragObject d,
    	...
    	Log.d("super_hw", "Workspace onDropCompleted");
        ...
        if (success && !(beingCalledAfterUninstall && !mUninstallSuccessful)) {
        	/** TODO 拖动删除桌面icon,当target不是同一个时,删除icon,(从一个容器,拖拽至其他容器,原容器的删除) */
...
//        return false;
    	// TODO super_hw 如果这个位置返回true,那么从拖动时,显示顶部的"应用信息模块"
    	return true;
    }
    ...
    void removeItemsByPackageName(final ArrayList<String> packages, final UserHandleCompat user) {
    	Log.d("super_hw", "Workspace removeItemsByApplicationInfo");
        final HashSet<String> packageNames = new HashSet<String>();
        packageNames.addAll(packages);
    ...
    void removeItemsByComponentName(final HashSet<ComponentName> componentNames,
    	...
    	Log.d("super_hw", "Workspace removeItemsByComponentName");
        ArrayList<CellLayout> cellLayouts = getWorkspaceAndHotseatCellLayouts();
	...
	public void addEmptyScreenBySomeWay(final AppInfo appInfo, final Launcher launcher,final int lastIndex) {
//		post(new Runnable() {
//			@Override
//			public void run() {
//				// TODO 安装窗口取消了,也能继续安装,所以暂时取消这个判断
////				if (mIsDragOccuring)
////					return;
//			}
//		});
		...
		addExtraEmptyScreenOnDrag();
		commitExtraEmptyScreen();
		long screenId = getScreenIdForPageIndex(lastIndex);
		if(screenId < 0)
			return;
		appInfo.screenId = screenId;
		ShortcutInfo sInfo = new ShortcutInfo(appInfo);
		View view = launcher.createShortcut(R.layout.application, (CellLayout)getPageAt(lastIndex), sInfo);
		addInScreen(view, -100, screenId, appInfo.cellX, appInfo.cellY, 1, 1, false);
		Log.i("super_hw", "新增一个APP page,并且新增一页 : " + lastIndex + " screenId : " + screenId + " X : " + appInfo.cellX + " Y : " + appInfo.cellY);
		LauncherModel.addItemInDatabase(launcher, sInfo, -100, screenId, appInfo.cellX, appInfo.cellY);
	}
	
	public boolean isDragOccuring(){
		return mIsDragOccuring;
	}

	public void deleteEmptyBySomeWay(){
		if (mIsDragOccuring)
			return;
		if (!mDeferRemoveExtraEmptyScreen) {
            removeExtraEmptyScreen(true, mDragSourceInternal != null);
